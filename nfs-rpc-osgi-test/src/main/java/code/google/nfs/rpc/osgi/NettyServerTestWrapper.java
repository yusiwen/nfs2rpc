...
@Component(name = "code.google.nfs.rpc.osgi.test.nettyserverwrapper", immediate = true, configurationPolicy = ConfigurationPolicy.REQUIRE)
public class NettyServerTestWrapper {

  private static final Log LOGGER = LogFactory.getLog(NettyServerTestWrapper.class);

  @Reference(service = Server.class, target = "(type=netty)", bind = "bind", unbind = "unbind")
  protected Server server = null;

  public void bind(Server s) {
    LOGGER.info("Binding NettyServer: " + s);
    server = s;
  }
