 ...
 *
 * Usage: -Dwrite.statistics=false BenchmarkClient serverIP serverPort concurrents timeout codectype requestSize
 * runtime(seconds) clientNums
 *
...
public abstract class AbstractBenchmarkClient {
  ...
  public void run(String[] args) throws Exception {
    ...
    for (int i = 0; i < concurrents; i++) {
      ClientRunnable runnable = getClientRunnable(serverIP, serverPort, clientNums, timeout, codectype, requestSize,
          barrier, latch, endtime, benchmarkBeginTime);
    ...
    System.out.println(" Requests: " + allRequest + " Success: " + (allRequestSum + ignoreRequest) * 100 / allRequest
    ...
    System.out.println(
        " Avg TPS: " + benchmarkRequest / times.keySet().size() + " Max TPS: " + maxTPS + " Min TPS: " + minTPS);
    ...
    System.out.println(" RT (500,1000]: " + (above500sum * 100 / allRequest) + "% " + above500sum + "/" + allRequest);
