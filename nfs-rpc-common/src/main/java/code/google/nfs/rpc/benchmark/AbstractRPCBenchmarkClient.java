...
public abstract class AbstractRPCBenchmarkClient extends AbstractBenchmarkClient {
   ...
   * return ProxyObject
   */
  public abstract BenchmarkTestService getProxyInstance(List<InetSocketAddress> servers, int clientNums,
      int connectTimeout, String targetInstanceName, Map<String, Integer> methodTimeouts, int codectype,
