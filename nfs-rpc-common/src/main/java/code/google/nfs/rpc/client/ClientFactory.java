...
public interface ClientFactory {
   ...
   * client.invokeSync then it'll throw NFSRPCRejectException
   */
  ...
  /**
   * get client,default targetIP:targetPort --> one connection u can give custom the key by give customKey
   */
  public Client get(final String targetIP, final int targetPort, final int connectTimeout, String... customKey)
      throws Exception;

  /**
   * get client,create clientNums connections to targetIP:targetPort(or your custom key)
   */
  public Client get(final String targetIP, final int targetPort, final int connectTimeout, final int clientNums,
